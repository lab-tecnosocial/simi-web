    ...
    return (
      <section className="font-roboto flex flex-col items-center py-10 bg-white">
        <div className="flex flex-col items-center mb-20">
          ...
          />
          <h2 className="text-5xl font-semibold text-[#000000]">Acerca de Simi</h2>
        </div>
  
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-6 w-full max-w-full">

          <div className="bg-[#DEF5CD] p-6 rounded-3xl shadow-md transition-transform duration-300 
                          hover:scale-105 hover:bg-[#c8e6a3] text-center w-full max-w-[520px]
                          h-auto md:h-[550px] md:translate-x-[-20px]">
            <img
              src="/assets/images/simicards.png"
              alt="Misión"
              className="w-16 h-16 mx-auto mt-6 mb-3"
            />
            <h3 className="text-[#59CB07] font-semibold text-3xl">Misión</h3>
            <p className="text-[#4B4B4B] mt-6 md:mt-24 text-base md:text-2xl leading-relaxed">
              Simi se trata de una aplicación para celulares que promueve el aprendizaje del
              quechua nivel básico de una forma amigable y accesible a través de unidades de
              aprendizaje que contienen audios e ilustraciones.
            </p>
          </div>
